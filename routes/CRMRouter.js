...
CRMRouter.get('/', (req,res) => res.send('Integration23'))
...
CRMRouter.get('/BusinessConnection/remove/:_id',passport.authenticate('jwt',{session: false}),(req,res)=>CRMController.deleteBusinessConnection(req,res))
